// JavaScript Document
        ...
        // typed text functionality
        const words = ["Computer Operator", "Front-end Developer", "Digital Marketer"];
        let wordIndex = 0;
        let charIndex = 0;

        function type() {
        const currentWord = words[wordIndex];
        document.getElementById("typed-text").textContent = currentWord.slice(0, charIndex);
        charIndex++;
...
// Mobile menu functionality
        ...
        form.addEventListener('submit', function(e) {
            ...
            // Agar fields empty hain → Browser required message show karega
            // Aur yahan se aage code run nahi hoga
            ...
            setTimeout(() => {
                btn.innerHTML = 'SUBMISSION COMPLETE';
